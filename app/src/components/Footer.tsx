        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col">
              ...
              <li>
                <Button variant="ghost" onClick={() => navigate("/about")} className="text-gray-600 hover:text-gray-900 cursor-pointer">
                  About
                </Button>
              </li>
              <li>
                <Button variant="ghost" onClick={() => navigate("/help")} className="text-gray-600 hover:text-gray-900 cursor-pointer">
                  Help & FAQ
                </Button>
              </li>
              <li>
                <Button variant="ghost" onClick={() => navigate("/contact")} className="text-gray-600 hover:text-gray-900 cursor-pointer">
                  Contact
                </Button>
              </li>
            </ul>
